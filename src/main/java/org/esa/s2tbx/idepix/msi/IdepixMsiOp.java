...
import org.esa.s2tbx.idepix.msi.IdepixMsiClassificationOp;
import org.esa.s2tbx.idepix.msi.operators.S2IdepixCloudBufferOp;
import org.esa.s2tbx.idepix.msi.util.AlgorithmSelector;
...
//    private boolean copyNNValue = true;
    ...
    private void processSentinel2() {
        ...
        s2ClassifProduct = GPF.createProduct(OperatorSpi.getOperatorAlias(IdepixMsiClassificationOp.class),
    ...
    private void computePostProcessProduct() {
        ...
        if (computeCloudShadow || computeMountainShadow) {
            ...
            postProcessingProduct = GPF.createProduct(OperatorSpi.getOperatorAlias(IdepixMsiPostProcessOp.class),
                                                      params, inputShadow);
        }
    }
